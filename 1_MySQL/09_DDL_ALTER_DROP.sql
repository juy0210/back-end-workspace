...
-- >> 변결하려는 자료형의 크기보다 이미 큰 값이 존재하면 에러 발생!
...
INSERT INTO dept_copy(dept_id, dept_title, location_id, came)
...
/*
     ...
     - 데이터 값이 기록되어 있어도 같이 삭제된다. (삭제된 컬럼 볼구는 불가능)
...
/*
     ...
     - ADD [CONSTRAINT 제약조건명] FOREIGN KEY(컬럼명) REFERNCES 테이블명(컬럼명);
...
ALTER TABLE dept_copy RENAME TO dept_test; -- 새로고침하면 변경되어있음
