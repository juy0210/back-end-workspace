...
VALUES ('개발자를 위한 생각의 정리, 문서 작성법', '카이마라 미즈히로', 20000, 1);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
VALUES ('1일 1로그 100일 완선 IT 지식', '브라이어w. 커니핸', 200000, 2);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
VALUES ('개발자가 영어로 잘해야 하나요?', '최희철', 27000, 3);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
VALUES ('피프웨어', '톰 드마르코', 16800, 2);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
VALUES ('그로스 해킹', '라이언 홀리데이', 13900, 3);
...
CREATE TABLE member (
	...
	gender CHAR(1) CHECK(gender IN ('M', 'F'1)),
    address VARCHAR(50),
    phone VARCHAR(20),
...
ALTER TABLE rent ADD CONSTRAINT book_no_fk
    FOREIGN KEY(rent_mem_no) REFERENCES book(book_no) ON DELETE SET NULL;
    
INSERT INTO rent(rent_mem, rent_book_no) VALUES(1, 2);
INSERT INTO rent(rent_mem, rent_book_no) VALUES(1, 3);
INSERT INTO rent(rent_mem, rent_book_no) VALUES(2, 1);
INSERT INTO rent(rent_mem, rent_book_no) VALUES(2, 2);
INSERT INTO rent(rent_mem, rent_book_no) VALUES(1, 5);
