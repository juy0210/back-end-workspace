...
- 서버 내부의 이미 만들어져 있는 정적인 요소들을 화면에 제공하는 열할
...
5. 컨테이너의 서블릿에 대한 설정은 배포 서술자(web.xml)에 작성하는게 원칙이다.
...
- 클라이언트의 요청을 서블릿에게 전달하기 위해서는 서블릿의 등록하고 매핑해야 한다.
...
<servlet-mapping>
     <serlvet-name>서블릿 이름</servlet-name>
