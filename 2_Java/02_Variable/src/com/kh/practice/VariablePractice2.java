...
public class VariablePractice2 {
	...
	public static void main(String[] args) {
		VariablePractice2 v = new VariablePractice2();		
//		v.method1();
//		v.method2();
//		v.method3();
//		v.method4();
...
//		v.method7();
	...
	public void method1() {
		...
		System.out.println("총 지불해야 할 급액 :" + total + "원");
	}
	...
	public void method4() {
		...
		System.out.printf("면적 : %.2fln", area);
		System.out.printf("둘레 : %.2f", size);
	}

	/* 5
	 * 영어 문자열 값을 입력 받아 문자에서 첫번째, 두번째, 마지막 글(문자열.length())자를 출력하세요.
	 * 
	 * 문자열을 입력하세요 : apple
	 * 첫번째 문자 : a
	 * 두번째 문자 : p
