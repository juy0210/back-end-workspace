...
public class D_Scanner {
	 ...
	 *                 sc.nextLine() - 공백 포함 엔저 전까지
	 *    - 정수일 때 : sc.nextInt()
	 *    - 실수일 때 : sc.nextFloat(), sc.next.Double()
	 *    
	...
	public static void main(String[] args) {
		...
		// printf 변경
		System.out.printf("당신의 이름은 %s이고 사는 곳은 %s, 나이는 %d살, 키는 %.1fcm, "
				+ "성별은 %c입니다.", name, addr, age, height, gender);
