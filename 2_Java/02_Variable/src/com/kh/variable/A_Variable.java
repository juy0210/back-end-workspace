...
//		variable.variableTest();
	...
	public void printValue() {
		...
		// 변수를 사용하지 않고 출력 syso > ctrl + spacebar
		System.out.println(10 * 2 * 3.141592);
		System.out.println(10 * 10 * 3.141592);
		
		System.out.println("---------------");
		
		// 변수를 사용하면 int r = 에 숫자를 입력하면 자동으로 숫자대로 변경됨
		// 변수를 사용하여 출력
		int r = 30;
		double pi = 3.141592;
		
		System.out.println(r * 2 * pi);
		System.out.println(r * r * pi); // syso 입력 후 ctrl + 스페이스바 > 엔터
	...
	public void variableTest() {
		 ...
		 * 
		 *   자료형 변수명;
		 *   - 자료형 : 어떤 갑을 저장할지, 어떤 크기의 메모리를 할당받을지에 대한 정보
...
//		isTrue = true; // 변수 초기화
		...
		// 2. 문자형 : 2byte(=16bit)
		char ch = 'a';
//		ch = 'ab'; // 문자형은 반드시 ''로만 ''은 --> 주석 단축키 : ctrl + /
		
		// 3. 정수형 : 4
		byte bNum = 1; // 1byte(=8bit)(-128 ~ 127) 256 = 2^8 = 2의8승
		// 8bit = 공간이 8개라는 뜻 [] [] [] [] [] [] [] []
//		bNum = 128; 에러 발생! -> 오버플로우(Overflow)
		short sNum = 128; // 2byte(=16bit)
		int iNum = 922337283; // 4byte (기본으로 쓰임)
		long lNum = 922337283458L; // 8byte - 숫자 뒤에 L(l)을 입력 L소문자 대문자 상관없음
...
//		int age@  도 오류 발생
		...
		// 4. 예약서(Reserved word)를 사용하면 안 된다.
//		int public;
//		int void;
//		int int;
//		int class;
//		int class2; 는 가능
		...
		int maxNumber; // 자바에서!
//		int Maxnumber; 도 되지만 Class와 구분하기 위해 잘 안쓴다
	}
