...
public class C_Mapping {
	...
	public void method2() {
		List<String> list = Arrays.asList("Java Lambda", "Stream Filtering Sortes Mapping");
...
//		    .flatMap(str -> Arrays.stream(str.split(" "))) // 단어들들 하나하나 세로로 나열
		    .forEach(System.out::println);
//		    .forEach(str -> System.out.println(str)); // 단어들을 하나씩 나열
		
	}
	
	/*
	 * adDoubleStream(), asLongStream(), boxed()
	 * - adDoubleStream : IntStream, LongStream을 DoubleStream으로 변환
	 * - asLongStream : InsStream을 LongStream으로 변환
	 * - boxed : int, long, double 요소를 Integer, Long, Double 요소호 박싱
	 * */
	public void method3() {
