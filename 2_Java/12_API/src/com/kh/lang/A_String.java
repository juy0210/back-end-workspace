...
public class A_String {
	...
	public void method1() {
		...
		String str4 = new String("hello"); // 이렇게도 쓸 수 있다
		
		System.out.println("str1 == str2 : " + (str1 == str2)); // true 둘 다 hello라서 같다고 인식
	...
	public void method2() {
		...
		System.out.println("1. charAt : " + ch); // 3번째 글자 l이 나옴
		
		// 2. concat(String str) : String
		//    전달받은 문자열과 원본 문자열을 하나로 합친 새로운 문자열을 생성해서 리턴
	    String str2 = str.concat("!!!!!");
	    str2 = str + "!!!!!";
	    System.out.println("2. concat : " + str2); // Hello, Java!!!!!!
	    ...
	    System.out.println("3. substring : " + str3); // Java! 7번째부터 끝까지의 글자 출력
	    System.out.println(str4); // Hello 0부터 5번째 글자 출력
	    
	    // 4. indexOf(String str) : int 
	    //    전달받은 str의 시작 인덱스를 리턴 (포함되어 있지 않으면 -1)
	    int index = str.indexOf("!");
	    System.out.println("4. indexOf : " + index); // 11 !가 위치하는 번호 출력
	    
	    int index2 = str.indexOf("Java");
	    System.out.println(index2); // 7 Java의 시작 위치 번호
	    ...
	    System.out.println("7. trim : " + str8); //          Hello,     Java!
	    String str9 = str8.trim();
	    System.out.println("trim 후 : " + str9); // Hello,     Java! 앞뒤공백제거
	...
	public void method3() {
		...
		sb.insert(1, "eeeee"); // Heeeeeello, Java! / eeeee를 추가
		
		// 3. delete(int start, int end) : StringBuilder
		//    start에서 end-까지의 인덱스에 해당하는 문자열 삭제
		...
		// sb2.delete(5, 12).sb2.append("API").sb2.reverse();
		sb2.delete(5, 12);
		sb2.append("API"); // OR sb2.insert(5, "API");
		sb2.reverse();
	...
	public void method4() {
		...
		// System.out.println(st.nextToken()); // 과목 개수 : 11
		
		// countTokens : 꺼내지 않고 남아있는 토큰의 수를 확인
		System.out.println("과목 개수 : " + st.countTokens()); // java.util.StringTokenizer@2eafffde
