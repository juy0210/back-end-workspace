 ...
 * - 자바에서 함수적 프로그래민을 위해서 자바 8부터 람다식을 지원
 * - 람다식은 매개변수를 가지는 함수와 같은 코드 블록이지만 런타임 시에는 
 *   인터페이스의 익명 수현 객체를 생성한다.
...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(app.plus(a, b)); // 13
		System.out.println(app.minus(a, b)); // 7
		System.out.println(app.multiple(a, b)); // 30
		System.out.println(app.divide(a, b)); // 3
