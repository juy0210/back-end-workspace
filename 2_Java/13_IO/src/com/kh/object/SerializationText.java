...
public class SerializationText {
	...
	public static void main(String[] args) {
		SerializationText s = new SerializationText();
//		s.fileSave();
//		s.fileRead();
//		s.objectsSave();
		s.objectsRead();
	...
	public void fileRead() {
		// 1. 스트림 생성
		// FileInputStream : 파일에 출력에 사용되는 기본 바이트 스트림 클래스
		// ObjectInputStream : 객체 단위로 출력 시에 바용되는 보조 바이트 스트림 클래스
	...
	public void objectsSave() throws ClassNotFoundException {
